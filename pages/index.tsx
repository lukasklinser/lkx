        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-24 gap-y-8 place-content-center">
          ...
          <div className="col md:col-span-2">
            ...
            <div className="mt-4">I'm currently building and designing things at {' '}
              <a href="https://angel.co/company/hivetechnologies" target="_blank" className="border-b border-black dark:border-gray-200 p1">hive.app</a> ↗, building the leading operations platform for independent commerce.</div>
